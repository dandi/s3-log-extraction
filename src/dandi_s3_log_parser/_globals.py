...
_DEFAULT_REGION_CODES_TO_COORDINATES = {
    ...
    "CO/Risaralda": {"latitude": 5.2102948, "longitude": -75.9842236},
    ...
    # "PE/Lima Province": {"latitude": None, "longitude": None}, -12.5453873, -75.8599243
    # "PL/Lesser Poland": {"latitude": None, "longitude": None},
    # "PL/Silesia": {"latitude": None, "longitude": None},
    # "PL/Subcarpathia": {"latitude": None, "longitude": None},
    # "PR/San Juan": {"latitude": None, "longitude": None},
    # "RU/Rostov": {"latitude": None, "longitude": None},
    # "TW/Takao": {"latitude": None, "longitude": None},
    # "UY/Montevideo Department": {"latitude": None, "longitude": None},
