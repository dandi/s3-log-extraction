...
def generate_archive_summaries(
    ...
    all_dandiset_summaries_by_day = [
        ...
        for dandiset_by_day_summary_file_path in summary_directory.rglob(pattern="dandiset_summary_by_day.tsv")
    ]
    ...
    archive_summary_by_day_file_path = summary_directory / "archive_summary_by_day.tsv"
    ...
    all_dandiset_summaries_by_region = [
        ...
        for dandiset_by_region_summary_file_path in summary_directory.rglob(pattern="dandiset_summary_by_region.tsv")
    ]
    ...
    archive_summary_by_region_file_path = summary_directory / "archive_summary_by_region.tsv"
