...
def behavior_tables(
    ...
    * per source *IP* (top-N by view sessions), with a stable CamelCase alias instead of the raw/hashed IP.
    ...
    per_service = pd.DataFrame(
        {
            ...
            "mean_dandisets_touched": grouped["n_dandisets_touched"].mean(),
            "mean_dandiset_coverage_fraction": grouped["dandiset_coverage_fraction"].mean(),
            "mean_within_dandiset_saturation": grouped["mean_within_dandiset_saturation"].mean(),
    ...
    cols = [
        ...
        "coverage_fraction",
        "n_dandisets_touched",
        "dandiset_coverage_fraction",
        "mean_within_dandiset_saturation",
        "max_within_dandiset_saturation",
        "session_gap_cv",
        "visit_gap_cv",
